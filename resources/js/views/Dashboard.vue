              ...
              <table class="table">
                ...
                <tbody>
                 ...
                 <tr>
                  ...
                  <tr>
                    <td>Total</td>
                    <td>{{ticketQueueNew13.length+ticketQueueNew12.length+ticketQueueNew11.length+ticketQueueNew10.length+ticketQueueNew9.length+ticketQueueNew8.length+ticketQueueNew7.length+ticketQueueNew6.length+ticketQueueNew5.length+ticketQueueNew3.length+ticketQueueNew2.length}}</td>
                  </tr>
                </tbody>
              </table>
            </div>
